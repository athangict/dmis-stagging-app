jQuery(function($) {
  ...
  $.extend( true, $.fn.dataTable.defaults, {
    dom:
      `<'row'<'col-12 col-sm-6 table-tools-col'b><'col-12 col-sm-6 text-right'f>><'row'<'col-12'tr>><''>`,
      "pageLength": 20,
      renderer: 'bootstrap'
  })
  ...
  var $_table = $(tableId).DataTable({
    ...
    buttons: {
      ...
      buttons: [
        {
          "extend": "excel",
          "text": "<i class='far fa-file-excel text-125 text-success-m1'></i> <span class='d-none'>Export to Excel</span>",
		...
		{
       "extend": "pdfHtml5",
			"text": "<i class='far fa-file-pdf text-125 text-danger-m2'></i> <span class='d-none'>Export to PDF</span>",
			"className": "btn-light-default btn-bgc-white btn-h-outline-primary btn-a-outline-primary",
			"exportOptions": {
			"columns": ":visible"}
        },
