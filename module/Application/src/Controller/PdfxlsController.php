...
class PdfxlsController extends AbstractActionController
{
	...
	*/
	public function init()
	{
		...
		if(!isset($this->_highest_role)){
			$this->_highest_role = $this->getDefinedTable("Acl\RolesTable")->getMax('id');  
		}
		if(!isset($this->_lowest_role)){
			$this->_lowest_role = $this->getDefinedTable("Acl\RolesTable")->getMin('id'); 
		}
	...
	**/
	...
	public function payreciptAction()
	{
        ...
        list($employee, $year, $month,$location, $region) = $id_parts;
